...
// import 'react-select/dist/react-select.css'; // Ensure this import is included
import Select from 'react-select'; // Import the Select component

function CreatePost2({ isAuth }) {
  ...
  const createPost = async () => {
    const formattedSkills = skills.join(', '); // Format skills as comma-separated string
